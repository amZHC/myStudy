这个笔记应该很长一段时间都不会更新了，我现在没有学单片机相关的。	-2026.9.13

笔记中好多代码混在同一行是因为我使用过其他md编辑器导致的，如果你要使用，调整一下换行就行，或使用代码格式化工具，我应该会把文件里都调整一遍。对，应该吧，如果没有调整的话还请见谅。如果你真的想看的话，给我发邮件，我一定尽快调整，不过应该也没人看。
